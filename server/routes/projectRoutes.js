...
// // GET: Fetch all projects (keep existing)
// router.get(
//   '/',
...
// // POST: Create a new project with media (keep existing)
// router.post(
//   '/',
//   upload.single('media'),
//   asyncHandler(async (req, res) => {
...
// // PUT: Update a project - FIXED VERSION
// router.put('/:id', asyncHandler(async (req, res) => {
//   const { title, description, techStack, githubUrl, liveDemo } = req.body;

//   console.log('Update request received:', { title, description, techStack, githubUrl, liveDemo });
...
// // DELETE: Remove a project by ID (keep existing)
// router.delete(
//   '/:id',
//   asyncHandler(async (req, res) => {
